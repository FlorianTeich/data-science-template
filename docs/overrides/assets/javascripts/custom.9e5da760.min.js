  ...
  var De = Me((Z) => {
    (function () {
      ...
      ((k = 150),
        ...
        (E = 150),
        (c = 0.75),
        (Z.score = function (v, x, S) {
          var T, y, g, _;
          return (
            (y = S.preparedQuery),
            (T = S.allowErrors),
            T || n(v, y.core_lw, y.core_up)
              ? ((_ = v.toLowerCase()), (g = r(v, _, y)), Math.ceil(g))
              : 0
          );
        }),
        (Z.isMatch = n =
          function (v, x, S) {
            ...
            for (T = -1, y = -1; ++y < _; ) {
              for (
                W = x.charCodeAt(y), U = S.charCodeAt(y);
                ++T < g && ((L = v.charCodeAt(T)), !(L === W || L === U));
        ...
        (Z.computeScore = r =
          function (v, x, S) {
            ...
            if (
              ...
              return l(Q, N, y, T.pos);
            if (((fe = x.indexOf(te)), fe > -1))
              return m(v, x, de, te, fe, Q, N);
            for (
              Ae = new Array(Q),
                W = new Array(Q),
                _r = w(Q, N),
            ...
            for (j = -1; ++j < N; ) {
              ...
              for (ce = 0, Er = 0, _ = 0, ye = !0, L = !0, M = -1; ++M < Q; ) {
                if (((Ke = Ae[M]), Ke > ce && (ce = Ke), (U = 0), te[M] === Or))
                  if (
                    ((Tr = u(j, v, x)),
                    (U = _ > 0 ? _ : d(v, x, de, te, j, M, Tr)),
                    (g = Er + p(j, M, Tr, y, U)),
                    g > ce)
                  )
                    ((ce = g), (re = V));
        ...
        (Z.scoreConsecutives = d =
          function (v, x, S, T, y, g, _) {
            var W, U, L, j, M, N, V;
            for (
              U = v.length,
                j = S.length,
  ...
  var wr = Me((Qe) => {
    (function () {
      ...
      ((a = De()),
        ...
        (c = 20),
        (t = 2.5),
        (Qe.score = function (s, p, d) {
          var l, m, h, b;
          return (
            (m = d.preparedQuery),
            (l = d.allowErrors),
            l || i(s, m.core_lw, m.core_up)
              ? ((b = s.toLowerCase()),
                (h = e(s, b, m)),
                (h = f(s, b, h, d)),
                Math.ceil(h))
        ...
        (f = function (s, p, d, l) {
          ...
          return (
            (h =
              b === -1
                ? d
                : k * e(s.slice(b + 1, E + 1), p.slice(b + 1, E + 1), S)),
            (m = (0.5 * c) / (c + r(s, E + 1, x))),
            m * h + (1 - m) * d * u(0, t * v)
          );
        }),
  ...
  var Gr = Me((to, oo) => {
    (function () {
      ...
      ((u = wr()),
        ...
        (f = function (c) {
          var a, s, p, d;
          for (s = "", p = 0, d = c.length; p < d; p++)
            ((a = c[p]), (s += a.toUpperCase()[0]));
          return s;
        }),
        (o = function (c) {
          var a, s, p;
          for (p = c.length, s = -1, a = []; ++s < p; ) a[c.charCodeAt(s)] = !0;
          return a;
        }));
    }).call(to);
  });
        ...
        (io.exports = function (i, f, u) {
          ...
          for (
            ...
            !(
              !!w &&
              ((l = m.score(w, f, u)),
              l > 0 && (h.push({ candidate: a, score: l }), !--b))
            ));
            k++
          );
          return (
      ...
      ((a = De()),
        ...
        (Sr.match = n =
          function (s, p, d) {
            ...
            return (
              ...
              (w = d.preparedQuery),
              (b = d.pathSeparator),
              l || t(s, w.core_lw, w.core_up)
                ? ((E = s.toLowerCase()),
                  (h = r(s, E, w)),
                  h.length === 0 ||
                    (s.indexOf(b) > -1 && ((m = e(s, E, w, b)), (h = i(h, m)))),
                  h)
                : []
            );
          }),
        (Sr.wrap = function (s, p, d) {
          ...
          for (b = "", l = -1, w = 0; ++l < h.length; ) {
            for (
              m = h[l], m > w && ((b += s.substring(w, m)), (w = m));
              ++l < h.length;
            ...
            (m++,
              m > w && ((b += v), (b += s.substring(w, m)), (b += k), (w = m)));
          }
        ...
        (e = function (s, p, d, l) {
          ...
          for (h = d.depth; h-- > 0; )
            if (((m = s.lastIndexOf(l, m - 1)), m === -1)) return [];
        ...
        (r = function (s, p, d, l) {
          ...
          for (
            ...
            ((Q[g] = 0), (S[g] = 0));
          for (y = -1; ++y < _; )
            for (V = 0, fe = 0, x = 0, de = p[y], g = -1; ++g < L; )
              ((T = 0),
                (k = 0),
                (re = fe),
                N[g] === de &&
                  ((te = o(y, s, p)),
                  (T = x > 0 ? x : c(s, p, M, N, y, g, te)),
                  (k = re + u(y, g, te, E, T))),
                (fe = Q[g]),
                (x = S[g]),
                V > fe ? (U = h) : ((V = fe), (U = w)),
      ...
      ((t = ao()),
        ...
        (r =
          (typeof process != "undefined" && process !== null
            ...
            : "/"),
        (so.exports = {
          filter: function (c, a, s) {
            return (
              s == null && (s = {}),
              a != null && a.length && c != null && c.length
                ? ((s = n(s, a)), t(c, a, s))
                : []
            );
          },
          score: function (c, a, s) {
            return (
              s == null && (s = {}),
              c != null && c.length && a != null && a.length
                ? ((s = n(s, a)),
                  s.usePathScoring ? i.score(c, a, s) : u.score(c, a, s))
                : 0
            );
          },
  ...
  function it(e, r, t) {
    ...
    function a(l) {
      l.value instanceof ge
        ? Promise.resolve(l.value.v).then(s, p)
        : d(i[0][2], l);
    }
    function s(l) {
      c("next", l);
...
` +
  ...
  var Ie = {
    setTimeout: function (e, r) {
      ...
      return n != null && n.setTimeout
        ? n.setTimeout.apply(n, H([e, r], R(t)))
        : setTimeout.apply(void 0, H([e, r], R(t)));
    },
  ...
  function ue() {}
  var ct = (function () {
    return Cr("C", void 0, void 0);
  })();
  function st(e) {
    return Cr("E", void 0, e);
  }
  function ut(e) {
    return Cr("N", e, void 0);
  }
  function Cr(e, r, t) {
  ...
  var Ue = (function (e) {
    ...
    return (
      ...
      (r.prototype.next = function (t) {
        this.isStopped ? Pr(ut(t), this) : this._next(t);
      }),
        ...
        if (O(t) || !t)
          ...
          i && ee.useDeprecatedNextContext
            ? ((u = Object.create(t)),
              ...
              (f = {
                next: t.next && Lr(t.next, u),
                error: t.error && Lr(t.error, u),
                complete: t.complete && Lr(t.complete, u),
              }))
            : (f = t);
        }
  ...
  var Io = { closed: !0, next: ue, error: Mo, complete: ue };
  var Le = (function () {
  ...
  function Lo(e) {
    return (e && e instanceof Ue) || (Co(e) && Be(e));
  }
  function Po(e) {
      ...
      (r.prototype.next = function (t) {
        ...
        Ce(function () {
          ...
          if ((o._throwIfClosed(), !o.isStopped)) {
            ...
            try {
              for (
                var f = X(o.currentObservers), u = f.next();
                !u.done;
                u = f.next()
              ) {
                var c = u.value;
    ...
    return (
      (r.prototype.next = function (t) {
        var o = this,
          ...
          u = o._timestampProvider,
          c = o._windowTime;
        (n || (i.push(t), !f && i.push(u.now() + c)),
          this._trimBuffer(),
      ...
      (r.prototype._trimBuffer = function () {
        var t = this,
          ...
          u = (f ? 1 : 2) * o;
        if ((o < 1 / 0 && u < i.length && i.splice(0, i.length - u), !f)) {
          for (var c = n.now(), a = 0, s = 1; s < i.length && i[s] <= c; s += 2)
            a = s;
          a && i.splice(0, a + 1);
        }
      }),
  ...
  var Ve = {
    setInterval: function (e, r) {
      ...
      return n != null && n.setInterval
        ? n.setInterval.apply(n, H([e, r], R(t)))
        : setInterval.apply(void 0, H([e, r], R(t)));
    },
  ...
  var gt = (function (e) {
    ...
    return (
      (r.prototype.flush = function (t) {
        this._active = !0;
        var o;
        t ? (o = t.id) : ((o = this._scheduled), (this._scheduled = void 0));
        var n = this.actions,
          i;
        t = t || n.shift();
  ...
  function Mt(e, r) {
    if (e != null) {
      ...
      if (ke(e)) return Tt(e, r);
      if (nr(e)) return Ot(e, r);
      if (ar(e)) return hr(e, r);
      if (sr(e)) return _t(e, r);
  ...
  function $o(e, r) {
    return Vo(r) ? e.apply(void 0, H([], R(r))) : e(r);
  }
  function He(e) {
    return C(function (r) {
      return $o(e, r);
  ...
  var Jo = ["addListener", "removeListener"],
    ...
    Xo = ["on", "off"];
  function $(e, r, t, o) {
    if ((O(t) && ((o = t), (t = void 0)), o)) return $(e, r, t).pipe(He(o));
    var n = R(
        Zo(e)
          ? Yo.map(function (u) {
              return function (c) {
                  ...
                  P(
                    ...
                    function (s) {
                      if (
                        ...
                        (n.next(t ? t.apply(void 0, H([], R(p))) : p),
                          i.some(function (d, l) {
                            return !d.length && f[l];
                          }) && n.complete());
                      }
    ...
    return A(function (r, t) {
      ...
      r.subscribe(
        P(
          t,
          function (a) {
            ((o = !0), (n = a), i || F(e(a)).subscribe((i = P(t, u, c))));
          },
          function () {
            ...
            function (f) {
              ...
              try {
                for (var d = X(n), l = d.next(); !l.done; l = d.next()) {
                  var m = l.value;
                  (m.push(f),
                    e <= m.length && ((p = p != null ? p : []), p.push(m)));
                }
              } catch (w) {
                u = { error: w };
              } finally {
      ...
      A(function (t, o) {
        ...
        function c() {
          var a = f + e,
            s = r.now();
          if (s < a) {
            ((n = this.schedule(void 0, a - s)), o.add(n));
            return;
          }
          u();
        }
        ...
        (v.add(function () {
          ...
          !s &&
            ...
            ((s = new Se({
              ...
              error: function (S) {
                ((h = !0), b(), (p = Kr(w, n, S)), x.error(S));
              },
              complete: function () {
                ((m = !0), b(), (p = Kr(w, f)), x.complete());
              },
            })),
            F(k).subscribe(s)));
      })(a);
  ...
  function Kr(e, r) {
    ...
    if (r !== !1) {
      ...
      return F(r.apply(void 0, H([], R(t)))).subscribe(n);
    }
  }
  function me(e, r, t) {
    var o,
      ...
      ? A(function (n, i) {
          ...
          n.subscribe(
            P(
              ...
              function (c) {
                var a;
                ((a = o.next) === null || a === void 0 || a.call(o, c),
                  i.next(c));
              },
              function () {
                var c;
              ...
              function (c) {
                var a;
                ((u = !1),
                  (a = o.error) === null || a === void 0 || a.call(o, c),
                  i.error(c));
              },
              function () {
                var c, a;
    ...
    return A(function (o, n) {
      ...
      o.subscribe(
        P(n, function (p) {
          if (c) {
            var d = H([p], R(f));
            n.next(t ? t.apply(void 0, H([], R(d))) : d);
          }
        }),
      );
    });
  ...
  function Vt() {
    for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
    return A(function (t, o) {
      Ft.apply(void 0, H([t], R(e))).subscribe(o);
    });
  }
  function Jr() {
    for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
    return Vt.apply(void 0, H([], R(e)));
  }
    ...
    return Te(
      () => (
        ...
        q(
          $(r, "load"),
          $(r, "error").pipe(
            D(() => jr(() => new ReferenceError(`Invalid script: ${e}`))),
          ),
        ).pipe(
          C(() => {}),
  ...
  var on = new K(),
    jp = Te(() =>
      ...
      C(() => new ResizeObserver((e) => e.forEach((r) => on.next(r)))),
    ...
    switch (e.getAttribute("data-mdx-mode")) {
      case "file":
        return Fe([
          ...
          C(([{ value: n }, i]) => (0, Zr.filter)(i, n)),
          D((n) =>
            r.pipe(
              C(({ icons: i }) => ({
                data: n.map((f) => ({
                  shortcode: f,
                  url: [i.base, f, ".svg"].join(""),
                })),
              })),
            ),
          ),
      ...
      default:
        return Fe([
          ...
          r.pipe(
            Nr(o),
            C(([{ icons: n, emojis: i }, f]) => [
              ...(["all", "icons"].includes(f) ? Object.keys(n.data) : []),
              ...(["all", "emojis"].includes(f) ? Object.keys(i.data) : []),
            ]),
          ),
        ]).pipe(
          C(([{ value: n }, i]) => (0, Zr.filter)(i, n)),
  ...
  function vo(e, { index$: r, query$: t, mode$: o }) {
    let n = new K(),
      ...
      f = ae(".mdx-iconsearch-result__meta", e);
    ...
    let u = e.getAttribute("data-mdx-mode") === "file",
      c = ae(":scope > :last-child", e);
    return (
      n
        .pipe(
          he(() => (c.innerHTML = "")),
        ...
        .subscribe(([a, { value: s }]) => c.appendChild(lo(a, s, u))),
      cn(e, { query$: t, index$: r, mode$: o }).pipe(
        he((a) => n.next(a)),
        le(() => n.complete()),
        C((a) => Je({ ref: e }, a)),
      )
  ...
  function bo(e) {
    let r = Bt(),
      ...
      i = new kr("all"),
      f = xe("iconsearch-select", e);
    for (let a of f)
      $(a, "change")
        .pipe(C((s) => s.target.value))
        .subscribe(i);
    let u = ro(o),
      c = vo(n, { index$: t, query$: u, mode$: i });
    return q(u, c);
  }
  function xo(e) {
    let r = gr("https://3if8u9o552.execute-api.us-east-1.amazonaws.com/_/"),
      t = xe("sponsorship-count"),
      o = xe("sponsorship-total");
    (r
      .pipe(
        D((i) => B(t).pipe(he((f) => (f.innerText = `${i.sponsors.length}`)))),
      )
        ...
        .pipe(
          D((i) =>
            B(o).pipe(
              he(
                (f) =>
                  (f.innerText = `$ ${i.total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} a month`),
              ),
            ),
          ),
        )
    ...
    return (
      n &&
        t.length &&
        r.subscribe((i) => {
          for (let f of i.sponsors)
            f.type === "public" && n.appendChild(mo(f.user));
          n.appendChild(
            ho(i.sponsors.filter(({ type: f }) => f === "private").length),
          );
        }),
  ...
  yo();
  var sn = document$.pipe(
    D(() =>
      q(
        ...xe("iconsearch").map((e) => bo(e)),
        ...xe("sponsorship").map((e) => xo(e)),
      ),
    ),
  );
  sn.subscribe();
